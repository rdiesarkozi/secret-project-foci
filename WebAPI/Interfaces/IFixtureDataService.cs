...
public interface IFixtureDataService
{
    ...
    public Task<FixtureDataDto> GetFixturesResultByMatchIdAsync(long matchId, int league, int season);
    
    public Task<List<FixtureDataDto>> GetAllUpcomingFixturesByLeagueAsync(int league, int season, int numberOfNextMatches);
}